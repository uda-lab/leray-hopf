...
--     (r3_NSForms_exist DISCHARGED — issue #48 — proved as theorem r3_NSForms_exists via the
--      sorry-free R3NSForms_of_gap; SWAPPED for the strictly-thinner r3ConvectionGap_exists;
