...
-- T³ trace + energy pillar foundations (conjuncts 1+3 campaign: Galerkin energy identity;
-- the good-representative construction and limit energy/trace theorems land in follow-up PRs)
