...
`exists_lerayHopf_r3_axiomatic`'s `#print axioms`.  After this change the capstone rests on the
four remaining project axioms: `curlSchwartzDense_holds`, `r3_NSForms_exist`, `aubin_lions_R3`,
...
(`curlSchwartzDense_holds`, `r3_NSForms_exist`, `aubin_lions_R3`, `galerkin_limit_passage_R3`).
