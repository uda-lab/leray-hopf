/-
# LerayHopf.Experimental — incomplete Bochner time-layer work (issue #147)
...
- **`LerayHopf.Bochner.TimeSobolevExperimental`** — `w1pTime_continuous_in_H`, the
  Lions–Magenes good-representative embedding `W^{1,p}(0,T;V) ∩ L^q(0,T;V') ↪ C([0,T];H)`.
  Declared MONTHS-CLASS residual (contract §2 / §7): statement kept intact, body deferred.
  This is the deepest single theorem of Stream D — the "weakly-continuous good representative"
  that `galerkin_limit_passage*` defers. Extracted from `TimeSobolev.lean` (which stays in the
