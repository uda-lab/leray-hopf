...
axiom: `galerkin_limit_passage_R3` (`R3/SolutionInterfaces.lean:558`), consumed once at
...
(`R3/SolutionInterfaces.lean:558`) and its torus twin. The axiom is applied to the **weak limit
